...
FindClustersForUniroot=function(x,object,nCluster=6,...) {
  print(x)
...
FindNClusters=function(object,nCluster=6,
                       resolution=0.8,
                       resolutionMin = max(0.2,resolution-1),resolutionMax = min(resolution+1,3),
                       verbose=FALSE,
                       ...) {
  #browser()
