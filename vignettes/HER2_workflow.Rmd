...
pdc.plt <- ModalityConcordancePlot(dataObj)+ggtitle("HER2")+theme_bw(base_size = 16)+theme(legend.position = "none")
#dev.off()
print(pdc.plt)
...
ssd.plt <- AverageSimilarityPlot(resultHer2Obj,varName)+theme_bw(base_size = 16)+theme(legend.position="none")
#dev.off()
print(ssd.plt)

cat("\n\n## Similarity To Neighbors \n\n")
#pdf(paste0("HER2","_SimilarToNeighbors2.pdf"))
snd.plt <- HighSimilarityNonNeighborPlot(resultHer2Obj)+theme_bw(base_size = 16)+theme(legend.position="none")+xlim(-4,1.5)+ylim(-3.5,2)
#dev.off()
print(snd.plt)
